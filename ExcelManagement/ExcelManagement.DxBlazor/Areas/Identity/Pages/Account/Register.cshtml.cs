...
//        public bool IsDepartmentDisabled { get; set; } = true;
...
//                //var addUserRoleResult = await _applicationUserManager.AddToRoleAsync(identity, Input.Role);
...
//        {
//            var departments = _departmentRepository.GetAllByCompanyId(companyId);
...
//            Departments = departmentDTOs.Select(d => new SelectListItem { Value = d.Id.ToString(), Text = d.DepartmentName }).ToList();
