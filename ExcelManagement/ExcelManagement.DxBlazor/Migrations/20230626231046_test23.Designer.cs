...
namespace ExcelManagement.DxBlazor.Migrations
{
    ...
    [Migration("20230626231046_test23")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FileAndFolderPerson", b =>
                {
                    b.Property<Guid>("FileAndFolderMemberId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("FileAndFolderMembersId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("FileAndFolderMemberId", "FileAndFolderMembersId");

                    b.HasIndex("FileAndFolderMembersId");
            ...
            modelBuilder.Entity("FileAndFolderPerson", b =>
                {
                    b.HasOne("ExcelManagement.DxBlazor.Data.Models.FileAndFolder", null)
                        .WithMany()
                        .HasForeignKey("FileAndFolderMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
